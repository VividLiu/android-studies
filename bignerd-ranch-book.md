...
1. [Ch 3: Activity Lifecycle](#chapter_3_activity_lifecycle)
1. [Ch 4: Debugging Android Apps](#chapter_4_debugging)
1. [Ch 5: Your Second Activity](#chapter_5_second_activity)
1. [Ch 6: Android SDK Versions and Compatibility](#chapter_6_android_sdk)
1. [Ch 7: UI Fragments and the Fragment Manager](#chapter_7_ui_fragments)
...
# Ch 3: Activity Lifecyle <a name="chapter_3_activity_lifecycle" >  </a>
...
- fixed vs runtime device configuaration:
    ...
    - runtime: 
        - screen orientation, keyboard availability,
          language, multi-window
...
- saving data:
  - onSaveInstanceState(Bundle outState): 
      ...
      -  Bundle: structure that maps string keys to limited
         value types
...
# Ch 4: Debugging Android Apps <a name="chapter_4_debugging"></a>
...
# Ch 5: Your Second Activity <a name="chapter_5_second_activity"></a>
...
# Ch 6: Android SDK Versions and Compatibility <a name="chapter_6_android_sdk"> </a>
...
# Ch 7: UI Fragments and the Fragment Manager <a name="chapter_7_ui_fragments"> </a>
  - fragment:
    ...
    - ui-fragment: fragments that manage the ui.
      ...
      - Dependencies:
        - Download via: File => Project Structure
      ...
      - AppCompatActivity: super class of activities
      - activity hosting ui fragment:
        - defined layout spot for fragment
        - manage fragment lifecycle 
          - stopped
          - paused
          - resumed
        - fragment activities called by hosting activity (OS knows nothing)
      - hosting fragment:
        - add fragment in activities layout:
          - inflexible (hardwire)
          - cannot swap fragment during activities lifetime
        - add fragment to activities code:
           - can control fragments at runtime
           - replace, remove, swap fragments
           - more complex
        - create ui fragment:
          - same as create activity
            - compose ui by defining widgets in layout
            - create class and set its view to be defined
            - wire up widgets inflated from the layout in code
          - Create new class
            - Super class is Fragment
            - version android.support.v4.app
        - activity life cycle methods:
          - fragment lifecycles are public (can be called by activity)
          	- activity private (only called by OS)
          - Fragment.onCreate does not inflate its view
            - onCreateView is used to inflate the view
              - LayoutInflator:
              - ViewGroup:
              - Bundle:
        - onCreateView:
            - explicitly inflate the view with: inflater.inflate
              - R.layout.fragment_crime: layout resource ID
              - container: views parent
              - false: whether or not to attach to views parent 
                - if false view in activity's code
